...
{% block details %}
    <div class="jsonrecord" data-id="{{ record._id }}" data-schema="{{ record.json['$schema'] }}">
      ...
      <textarea id="{{ record._id }}" class="jsonrecord-blob" name="{{ record._id }}">{{ record.jsonblob }}</textarea>
    </div>
    <div class="panel panel-default jsonrecord-metadata">
      ...
      <div class="row panel-body">
        ...
        <div class="col-md-10"><a href="{{ url_for('schema.index') }}#{{ record.json.get('$schema') }}">{{ record.json.get('$schema') }}</a></div>
