...
@register_breadcrumb(blueprint, '.schema', _('JSON Schema'))
def index():
    ...
    return render_template('schema/schema.html', tree=_tree_sort(tree))


@blueprint.route('/<path:path>')
def schema(path):
    """Serve static schema file."""
    return current_app.send_static_file(os.path.join('gen', 'schema', path))
